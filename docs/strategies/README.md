...
| BA-007 | Crypto Cross-Sectional Selection | **Evaluation complete — FAIL, honest stop** (both signals failed their own gates; see [first-sweep note](../notes/2026-09-09-ba007-first-cross-sectional-sweep.md)). XS-MOM beat its controls in development and reversed in validation with a bootstrap interval containing zero; XS-CARRY failed 0/6 — the funding cross-section was positively predictive of returns on this archive. Sealed window unspent. Data family: Binance USDT-M perps via data.binance.vision. | [BA-007.md](BA-007.md) |
| BA-008 | Funding Momentum (XS-FMOM) | **Pre-registered 2026-09-09 — forward-only test.** The mirror image BA-007 was not allowed to score: long high funding, short low. Graded exclusively on sessions on or after 2026-10-01 at 52- and 104-week evidence bars; no backtest over seen data permitted. Born from BA-007's un-promoted observation, stated in §2 with its discount. | [BA-008.md](BA-008.md) |
