...
| BA-009B | Dated/Perpetual Futures Spreads | **First feasibility test complete; no pilot justified.** Current quotes are thin after cost stresses; conditional spread hypothesis unresolved pending synchronized historical quotes and funding marks. [Result](../notes/2026-09-09-ba009b-first-feasibility.md) | [BA-009B.md](BA-009B.md) |
