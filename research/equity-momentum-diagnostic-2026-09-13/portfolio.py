"""A $10,000 momentum cash account with monthly rank-based retention.
...
D = Decimal
ZERO, CENT = D(0), D('.01')
POLICY_SHA256 = 'bb794d736f507c5a3ee7838eb73cd993b10dd4a12655f6dd72f69fa7dc3bfaa9'
...
def simulate(*, calendar, prices, candidates, actions=(), cost_case='base',
    ...
    for original in candidates:
        ...
        if day != min(d for d in calendar if d[:7] == day[:7]):
            raise ValueError('Momentum review must be first session of month')
        event['exit_date'] = end
